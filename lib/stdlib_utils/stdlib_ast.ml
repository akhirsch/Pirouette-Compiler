  ...
  [
    ForeignDecl
      ( VarId ("print_string_PIROUETTE_ID", ()),
        TFun (TLoc (LocId ("PIRSTDLIBLOC", ()), TString (), ()), TUnit (), ()),
        "print_string",
        () );
    ForeignDecl
    ...
    ForeignDecl
      ( VarId ("print_int_PIROUETTE_ID", ()),
        TFun (TLoc (LocId ("PIRSTDLIBLOC", ()), TInt (), ()), TUnit (), ()),
        "print_int",
        () );
    ForeignDecl
    ...
    ForeignDecl
      ( VarId ("filenm_get_current_dir_name_PIROUETTE_ID", ()),
        TFun (TUnit (), TLoc (LocId ("PIRSTDLIBLOC", ()), TString (), ()), ()),
    ...
    ForeignDecl
      ( VarId ("sys_get_wordsize_PIROUETTE_ID", ()),
        TFun (TUnit (), TLoc (LocId ("PIRSTDLIBLOC", ()), TInt (), ()), ()),
        "((fun () -> (Sys.word_size)))",
        () );
    ForeignDecl
    ...
    ForeignDecl
      ( VarId ("sys_check_big_endian_PIROUETTE_ID", ()),
        TFun (TUnit (), TLoc (LocId ("PIRSTDLIBLOC", ()), TBool (), ()), ()),
        "((fun () -> (Sys.big_endian)))",
        () );
    ForeignDecl
    ...
    ForeignDecl
      ( VarId ("err_record_backtrace_PIROUETTE_ID", ()),
        TFun (TLoc (LocId ("PIRSTDLIBLOC", ()), TBool (), ()), TUnit (), ()),
