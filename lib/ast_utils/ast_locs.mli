...
module LocSet : sig
  ...
  (** [max_elt_opt s] returns [Some loc] where [loc] is the largest location,
      or [None] if [s] is empty.
  ...
  (** [choose_opt] returns [Some loc] for an arbitrary location,
      or [None] if [s] is empty.
      
    {b Category:} Selection *)
  val choose_opt : t -> elt option

  (** [split] returns [(l, present, r)] where [l] contains locations
      less than [loc], [present] is true if [loc] was in [s], and [r] contains
      locations greater than [loc].
  ...
  (** [find_first_opt] returns [Some loc] for the smallest location
      satisfying [p], or [None] if none exists.
  ...
  (** [find_last_opt] returns [Some loc] for the largest location
      satisfying [p], or [None] if none exists.
  ...
  (** [to_seq_from loc s] returns a sequence of locations >= [loc] in ascending order.
...
(** [extract_stmt_block stmts] extracts all location identifiers mentioned
    in a choreographic statement block.
