...
let domain_Alice =
  Domain.spawn (fun _ ->
      ...
      let rec main_PIROUETTE_ID =
        let rec x_PIROUETTE_ID =
          print_string_PIROUETTE_ID "hello from Alice "
        in
        ()
      in
      ())
