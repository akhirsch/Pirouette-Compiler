...
let test_23_dot _ = deq Dotgen_testcases.pir_23 Dotgen_testcases.dot_23
let test_24_dot _ = deq Dotgen_testcases.pir_24 Dotgen_testcases.dot_24
let test_25_dot _ = deq Dotgen_testcases.pir_25 Dotgen_testcases.dot_25

(* 
let test_26_dot _ = deq Dotgen_testcases.pir_26 Dotgen_testcases.dot_26
;; *)
...
let suite =
  ...
  >::: [
         ...
         "testcase7" >::: [ "testcase7" >:: test_7_dot ];
         "testcase8" >::: [ "testcase8" >:: test_8_dot ];
         "testcase9" >::: [ "testcase9" >:: test_9_dot ];
         "testcase10" >::: [ "testcase10" >:: test_10_dot ]
         (* ; "testcase11"
         ...
         "testcase21" >::: [ "testcase21" >:: test_21_dot ];
         "testcase22" >::: [ "testcase22" >:: test_22_dot ];
         "testcase23" >::: [ "testcase23" >:: test_23_dot ];
         "testcase24" >::: [ "testcase24" >:: test_24_dot ];
         "testcase25" >::: [ "testcase25" >:: test_25_dot ]
         (* ; "testcase26"
